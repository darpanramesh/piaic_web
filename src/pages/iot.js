...
export default class Iot extends React.Component{
    render(){
        return(
            <div>
                ...
                <div className={classes.iotmain}>
                    <h1 className={classes.ioth1} >Internet of Things and AI Specialist</h1>
                    <h6 className={classes.iotp}>A FIFTEEN MONTHS IOT AND AI PROGRAM DESIGNED FOR ABSOLUTE BEGINNERS GETTING PAKISTAN READY FOR THE NEW ERA OF INTERNET OF<br />
                    THINGS AND AI.</h6>
                    </div>
                </center>
            ...
            <CardExample title="Quarter 1" text="Introduction to IoT Concepts and Rust Programming" style={{background:'white',color:"#000000",marginRight:'20px'}} />
            <CardExample title="Quarter 2" text="Embedded Rust and Real-time Systems Programming" style={{background:'#e1f1f0',color:"#000000",marginRight:'20px'}} />
            <CardExample title="Quarter 3" text="Micro Services Development for IoT Edge and IoT Cloud using Web Assembly, Node.js, Docker and KubeEdge technologies" style={{background:'#c6e3e2',color:"#000000",marginRight:'20px'}} />
            <CardExample title="Quarter 4" text="Voice Computing for Device Control" style={{background:'#a8d4d3',color:"#000000",marginRight:'20px'}} />
            </div>
            <div style={{display:'flex'}}>
            <CardExample title="Quarter 5" text="Artificial Intelligence (AI) for Internet of Things (IoT)" style={{background:'#8dc7c5',color:"#000000",marginRight:'20px'}} />
            <CardExample title="Quarter 6" text="Blockchain and IOTA Technologies for IoT (Optional)" style={{background:'#22a19d',color:"#000000",marginRight:'20px'}} />
            </div>
            <br /><br />
            <p style={{marginLeft:"25px",color:'gray'}}>----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p>
            <div className={classes.iotmain4}>
      ...
      <Grid container justifyContent={"center"}>
        ...
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#8dc7c5" }}className={Styles.vertical_line} >
        ...
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderLeft: "2px solid", borderColor: "#8dc7c5" }} className={Styles.vertical_line}>
        </Grid>
...
{/* section 3 */}
        ...
        <Grid xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderLeft: "2px solid", borderColor: "#8dc7c5" }} className={Styles.vertical_line}>
        </Grid>
...
{/* section 4 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#8dc7c5" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#8dc7c5",borderColor:"#8dc7c5",color:"white"}}>2A</span>
        </Grid>
        ...
        {/* section 5 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#8dc7c5" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#8dc7c5",borderColor:"#8dc7c5",color:"white"}}>2B</span>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 6 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#8dc7c5" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#8dc7c5",borderColor:"#8dc7c5",color:"white"}}>2C</span>
        </Grid>
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} className={Styles.right_Side_box}>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 7 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#8dc7c5" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#8dc7c5",borderColor:"#8dc7c5",color:"white"}}>3A</span>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 8 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#8dc7c5" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#8dc7c5",borderColor:"#8dc7c5",color:"white"}}>3B</span>
        </Grid>
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} className={Styles.right_Side_box}>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 9 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#8dc7c5" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#8dc7c5",borderColor:"#8dc7c5",color:"white"}}>3C</span>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 10 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#8dc7c5" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#8dc7c5",borderColor:"#8dc7c5",color:"white"}}>3D</span>
        </Grid>
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} className={Styles.right_Side_box}>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
          <span className={Styles.counter} style={{backgroundColor:"#22a19d",borderColor:"#22a19d",color:"white"}}>4</span>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
