...
import Styles from "./../styles/cloudnative.module.scss"
...
export default class CloudNative extends React.Component{
    render(){
        return(
            <div>
                <AppBar />
                <center>
                <div className={classes.cnmain}>
                    <h1 className={classes.cnh1} >Cloud Native and Web Computing Specilist</h1>
                    <h6 className={classes.cnp}>A ONE YEAR CLOUD COMPUTING PROGRAM DESIGNED FOR ABSOLUTE BEGINNERS.<br />
                    GETTING PAKISTAN READY FOR THE NEW ERA OF MICROSERVICES AND MULTI-CLOUD NATIVE COMPUTING.</h6>
                    </div>
                </center>
            <div className={classes.cnmain2}>
                <h2>Program Structure</h2>
                <h4 className={classes.cnmain3}>A four-quarter cloud computing program.</h4>
            </div>
            <div style={{display:'flex'}}>
            <CardExample title="Quarter 1" text="Cloud Native Computing Foundations" style={{background:'white',color:"#e1006a",marginRight:'20px'}} />
            <CardExample title="Quarter 2" text="Developing Cloud Native Microservices" style={{background:'#ef7fb3',color:"white",marginRight:'20px'}} />
            <CardExample title="Quarter 3" text="Kubernetes in Practice" style={{background:'#e8408e',color:"white",marginRight:'20px'}} />
            <CardExample title="Quarter 4" text="AWS Application Development" style={{background:'#e1006a',color:"white",marginRight:'20px'}} />
            </div>
            <br /><br />
            <p style={{marginLeft:"25px",color:'gray'}}>----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p>
            <div className={classes.cnmain4}>
      ...
      <Grid container justifyContent={"center"}>
        ...
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#e8408e" }}className={Styles.vertical_line} >
        ...
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderLeft: "2px solid", borderColor: "#e8408e" }} className={Styles.vertical_line}>
        </Grid>
...
{/* section 3 */}
        ...
        <Grid xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderLeft: "2px solid", borderColor: "#e8408e" }} className={Styles.vertical_line}>
        </Grid>
...
{/* section 4 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#e8408e" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#e8408e",borderColor:"#e8408e",color:"white"}}>2A</span>
        </Grid>
        ...
        {/* section 5 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#e8408e" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#e8408e",borderColor:"#e8408e",color:"white"}}>2B</span>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 6 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#e8408e" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#e8408e",borderColor:"#e8408e",color:"white"}}>2C</span>
        </Grid>
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} className={Styles.right_Side_box}>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 7 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#e8408e" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#e8408e",borderColor:"#e8408e",color:"white"}}>3A</span>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 8 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#e8408e" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#e8408e",borderColor:"#e8408e",color:"white"}}>3B</span>
        </Grid>
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} className={Styles.right_Side_box}>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 9 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#e8408e" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#e8408e",borderColor:"#e8408e",color:"white"}}>3C</span>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        {/* section 10 */}
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} style={{ borderRight: "2px solid", borderColor: "#e8408e" }} className={Styles.vertical_line}>
          <span className={Styles.counter} style={{backgroundColor:"#e8408e",borderColor:"#e8408e",color:"white"}}>3D</span>
        </Grid>
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12} className={Styles.right_Side_box}>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
        ...
        <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
          <span className={Styles.counter} style={{backgroundColor:"#e8408e",borderColor:"#e8408e",color:"white"}}>4</span>
          <Grid xl={12} lg={12} sm={12} style={{display: "flex",justifyContent: "center",paddingBottom: "80px",}}>
            <Paper className={Styles.paper}>
