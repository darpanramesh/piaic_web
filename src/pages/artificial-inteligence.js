...
export default class ArtificialIntelligence extends React.Component {
    render() {
        return (
            <div>
                <AppBar />
                <center>
                    <div className={Styles.main}>
                        <h1 className={Styles.h1} >Artificial-Intelligence</h1><br />
                        <h6 className={Styles.p}>A ONE YEAR AI PROGRAM DESIGNED FOR ABSOLUTE BEGINNERS.<br />
                            GETTING PAKISTAN READY FOR THE NEW ERA OF COMPUTING ENABLED BY THE RISE OF AI.</h6>
                    </div>
                </center>
                <div className={Styles.main2}>
                    <h2 className={Styles.main3}>Program Structure</h2>
                    A four-quarter AI program in Data Science, Machine Learning,
                    <br /> and Deep Learning.
                </div>
                ...
                <div style={{ display: 'flex' }}>
                    <Grid justify='center' container>
                        <Grid item xs={12} sm={12} md={8} lg={3}>
                            <Paper className={Styles.cardMain} style={{ background: 'white', color: "#192A56", marginLeft: '25px', }}>
                                <Typography variant='h4' align='center' className={Styles.title} >Quarter 1</Typography>
                                <Typography variant='p' align='center' className={Styles.text} >AI Foundation</Typography>
                            </Paper>
                        </Grid>
                        <Grid item xs={12} sm={12} md={8} lg={3}>
                            <Paper className={Styles.cardMain} style={{ background: '#8c94aa', color: "white", marginLeft: '25px' }}>
                                <Typography variant='h4' align='center' className={Styles.title} >Quarter 2</Typography>
                                <Typography variant='p' align='center' className={Styles.text} >Introducting to Data science and deep learning</Typography>
                            </Paper>
                        </Grid>
                        <Grid item xs={12} sm={12} md={8} lg={3}>
                            <Paper className={Styles.cardMain} style={{ background: '#535f80', color: "white", marginLeft: '25px' }}>
                                <Typography variant='h4' align='center' className={Styles.title} >Quarter 3</Typography>
                                <Typography variant='p' align='center' className={Styles.text} >Deploying AI Solution</Typography>
                            </Paper>
                        </Grid>
                        <Grid item xs={12} sm={12} md={8} lg={3}>
                            <Paper className={Styles.cardMain} style={{ background: '#192a56', color: "white", marginLeft: '25px' }}>
                                <Typography variant='h4' align='center' className={Styles.title} >Quarter 4</Typography>
                                <Typography variant='p' align='center' className={Styles.text} >AI in practice</Typography>
                            </Paper>
                        </Grid>
                    </Grid>
                </div>
                    ...
                    <Grid item xl={6} lg={6} md={6} sm={6} xs={12} className={Styles.right_Side_box}>
                        <Grid xl={12} lg={12} sm={12} style={{ display: "flex", justifyContent: "center", paddingBottom: "80px", }}>
                            <Paper className={Styles.paper}>
                                ...
                                <p className={Styles.discription}>
                                    <img src={keras_icon} className={Styles.program_icons} width='150' />
